...
export default function NewsletterSignup({ compact = false }: Props) {
  ...
  if (compact) {
    return (
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2 items-stretch sm:items-center">
        <span className="text-xs font-semibold text-gray-300 whitespace-nowrap">The Steady Recovery Letter</span>
        <input
          type="email"
          value={email}
  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-2xl px-6 py-8 max-w-xl mx-auto text-center">
      <h2 className="text-xl font-bold text-gray-900 mb-1">The Steady Recovery Letter</h2>
      <p className="text-sm text-gray-500 mb-6">Weekly addiction treatment and MAT insights, delivered Thursday</p>
