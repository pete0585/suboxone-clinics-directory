...
function UnsubscribeContent() {
  ...
  const niche = searchParams.get('niche') ?? 'suboxone'
  ...
  if (status === 'done') {
    return (
      <div className="mx-auto max-w-lg px-4 py-20 text-center">
        ...
        <p className="text-gray-500 mb-6">You&apos;ve been removed from <strong>The Steady Recovery Letter</strong>. No more emails from us.</p>
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-20 text-center">
      ...
      <p className="text-gray-600 mb-2">
        Unsubscribe <strong>{decoded || 'your email'}</strong> from <strong>The Steady Recovery Letter</strong>?
      </p>
