...
const NICHE = 'suboxone' as const
const DIRECTORY_SLUG = 'suboxone-clinics-directory' as const
const NEWSLETTER_NAME = 'The Steady Recovery Letter' as const
const CONFIRM_URL_BASE = 'https://www.suboxoneclinicfinder.com/newsletter/confirm'
